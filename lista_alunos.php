...
<body>
    <div class="container mt-5">
                ...
                <tbody>
                    <?php foreach($lista as $aluno): ?>
                        <tr>
                            ...
                            <td>
                                <a href="editar_aluno.php?id=<?php echo $aluno['id_aluno']; ?>" class="btn btn-sm btn-danger">Editar</a><br><br>
        ...
        <div class="text-right mt-3">
            <a href="cadastrar_aluno.php" class="btn btn-danger">Cadastrar Novo Aluno</a>
        </div>
    </div>
</body>
</html>
