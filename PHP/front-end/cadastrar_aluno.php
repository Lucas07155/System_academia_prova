...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/estilo_cds_aluno.css">
</head>
<body>
    ...
    <main class="container mt-5">
        <section>
            ...
            <article>
                <form action="../crud/processar_cadastro_aluno.php" method="POST">
                    ...
                    <br><a href="area_adm.php" class=" btn btn-sm btn-primary mt-3">Volta pra pagina anterior</a>
                </form>
            </article>
        </section>
    </main>
    ...
    <aside class="container mt-4">
        <div class="alert alert-info">
            <strong>Dica:</strong> Certifique-se de preencher todos os campos corretamente antes de enviar o formulário.
        </div>
    </aside>
